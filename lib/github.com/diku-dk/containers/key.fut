...
module u64key_u32 : key with ctx = () with key = u64 with hash = u32 with const = (u128, u128) = mk_int_key_u32 u64 -- This is the error, need a smarter way of handling this case.
